...
def get_location(food_hall: str, browser):  # google maps API
    ...
    prompt = f'Given this text content, determine the location of the food hall "{food_hall}"' + \
...
def get_square_footage(food_hall: str, browser):
    ...
    res = None
    location_instruction = "You are a market researcher and you are helping me find information about certain food halls."
    prompt = f'Given this text content, determine the square footage of "{food_hall}"' + \
...
def get_number_of_food_stalls(food_hall: str, browser):
    ...
    location_instruction = "You are a market researcher and you are helping me find information about certain food halls."
    prompt = f'Given this text content, determine the number of food stalls, bar stalls, and retail stalls in "{food_hall}"' + \
...
def get_types_of_food_stalls(food_hall: str, browser):
    ...
    prompt = f'Given this text content, list the types of food stalls available in "{food_hall}"' + \
...
def get_demographic(food_hall: str, browser):
    ...
    prompt = f'Analyze this text content to provide demographic information of the area surrounding "{food_hall}"' + \
...
def get_local_area_composition(food_hall: str, browser):
    ...
    prompt = f'Evaluate the text content to describe the area composition around "{food_hall}"' + \
...
def get_public_transport(food_hall: str, browser):
    ...
    prompt = f'Summarize information about nearby public transport for "{food_hall}"' + \
...
def get_parking_availability(food_hall: str, browser):
    ...
    prompt = f'Provide details on parking at "{food_hall}".' + \
...
def get_foot_traffic_estimates(food_hall: str, browser):
    ...
    prompt = f'Determine the average foot traffic near "{food_hall}".' + \
...
def get_annual_visitor_count(food_hall: str, browser):
    ...
    prompt = f'Extract information on annual visitor count for "{food_hall}"' + \
...
def get_lease_rates(food_hall: str, browser):
    ...
    prompt = f'Provide the average lease rate for spaces within "{food_hall}".' + \
...
def get_occupancy_rate(food_hall: str, browser):
    ...
    prompt = f'Analyze to provide the occupancy rate for "{food_hall}".' + \
...
def get_year_established(food_hall: str, browser):
    ...
    prompt = f'Find out the year of establishment for "{food_hall}".' + \
...
def get_renovation_history(food_hall: str, browser):
    ...
    prompt = f'Detail the renovation history of "{food_hall}".' + \
...
def get_owner(food_hall: str, browser):
    ...
    prompt = f'Identify the owner of "{food_hall}". ' + \
...
def get_management_company(food_hall: str, browser):
    ...
    prompt = f'Find out the management company for "{food_hall}".' + \
